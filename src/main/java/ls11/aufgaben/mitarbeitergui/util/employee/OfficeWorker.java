...
import ls11.aufgaben.mitarbeitergui.util.employee.util.MitarbeiterType;
...
public class OfficeWorker extends Employee {
    ...
    private static final double MINIMUM_WAGE = 300;
    /**
    ...
    protected void setFestgehalt(double festgehalt) {
        if (festgehalt < 0) {
            throw new IllegalArgumentException("Das Festgehalt eines Arbeiters kann nicht negativ sein!");
        }
        if (festgehalt < MINIMUM_WAGE) {
            throw new IllegalArgumentException("Das Festgehalt des Arbeiters ist zu gering. Mindestwert sind " + MINIMUM_WAGE);
        }
